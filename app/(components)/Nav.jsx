        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <ul className=" font-medium flex justify-start sm:justify-center sm:items-center items-start flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700  ">
              ...
              {
                session &&(
                  <Link href={'/AddProduct'} className={`${url=='/AddProduct'?"text-blue-500 dark:text-blue-500 mt-2 md:mt-0":""}`}>
                    Add an item
                  </Link>
              ...
              <li className="mt-2 md:mt-0 mb-4 md:mb-0">
                {session ? (
                  <Link href="/api/auth/signout?callbackUrl=/" className="text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-yellow-600 dark:hover:bg-yellow-700 focus:outline-none dark:focus:ring-yellow-800 mt-5 md:mt-0">Logout</Link>
                ) : (
                  <Link href="/api/auth/signin" className=" mt-2 md:mt-0 block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Login</Link>
                )}
              </li>
              <li>
                {
